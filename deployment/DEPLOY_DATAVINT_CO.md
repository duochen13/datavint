# Deploy DataVint to datavint.co

**Quick deployment guide for getting datavint.co live in ~30 minutes**

---

## Step 1: Register datavint.co (5 minutes)

### Option A: Namecheap (Recommended)
1. Go to https://www.namecheap.com
2. Search for "datavint.co"
...
Now we'll point datavint.co to your deployed apps.

### If using Namecheap:

1. Log in to Namecheap
2. Go to "**Domain List**" → Click "**Manage**" for datavint.co
3. Click "**Advanced DNS**" tab
4. Add these records:

**For Frontend (datavint.co):**
```
Type: A Record
Host: @
...
2. Click on datavint.co domain
3. Go to "**DNS**" → "**Records**"
4. Add the same records as above
5. **Turn OFF orange cloud** (proxy) for api.datavint.co initially
...
### 5.1 Update Frontend
The frontend is already configured to use `https://api.datavint.co`

Check: `client/.env.production` should have:
```bash
VITE_API_URL=https://api.datavint.co
```
...
### Test API Docs
Visit: https://api.datavint.co/api/docs
Should show FastAPI Swagger UI

### Test Frontend
1. Visit: https://datavint.co
...
git commit -m "fix: update CORS for datavint.co"
git push
```
...
- **Domain (datavint.co)**: $35-40/year (~$3/month)
...
### Share your app:
- Twitter: "Just launched datavint.co - AI-powered data quality for ML pipelines"
